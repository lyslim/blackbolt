...
*/
        ...
        create_grid: function()
        {
            var colModel   = new Ext.grid.ColumnModel([
                {header: 'Service Center Staff', width: 200, menuDisabled: true, sortable: false, locked: true, dataIndex: 'item_name', renderer: this.onItemNameRenderer.createDelegate(this) },
